...
function update() {
    ...
    displayTo(to, x+650, y+200);
    displayClass(tclass, x+65, y+400);
    displayDate(date, x+230, y+400);
    displayType(transaction, x+425, y+400);
    displayAdult(adult, x+690, y+400);
    displayChild(child, x+815, y+400);
    displayFare(fare, x+935, y+400);
};
...
var tx = canvas.width -30;
var ty = canvas.height / 4 -50;
ctx.drawImage(image, x + 10 , y, tx, ty); // 1080 x 480
